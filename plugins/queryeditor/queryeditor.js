...
//						PM.ajaxIndicatorHide();
		...
		setSelection: function(type) {
			...
			switch(type) {
				case 'add': 
					$('#queryeditor-add').removeClass('queryeditor_add_off').addClass('queryeditor_add_on');
					$('#queryeditor-del').removeClass('queryeditor_del_on').addClass('queryeditor_del_off');
					$('#queryeditor-new').removeClass('queryeditor_new_on').addClass('queryeditor_new_off');
					$('#queryeditor-intersec').removeClass('queryeditor_intersec_on').addClass('queryeditor_intersec_off');
					break;
				case 'del': 
					$('#queryeditor-add').removeClass('queryeditor_add_on').addClass('queryeditor_add_off');
					$('#queryeditor-del').removeClass('queryeditor_del_off').addClass('queryeditor_del_on');
					$('#queryeditor-new').removeClass('queryeditor_new_on').addClass('queryeditor_new_off');
					$('#queryeditor-intersec').removeClass('queryeditor_intersec_on').addClass('queryeditor_intersec_off');
					break;
				case 'new':
					$('#queryeditor-add').removeClass('queryeditor_add_on').addClass('queryeditor_add_off');
					$('#queryeditor-del').removeClass('queryeditor_del_on').addClass('queryeditor_del_off');
					$('#queryeditor-new').removeClass('queryeditor_new_off').addClass('queryeditor_new_on');
					$('#queryeditor-intersec').removeClass('queryeditor_intersec_on').addClass('queryeditor_intersec_off');
					break;
				case 'intersec':
					$('#queryeditor-add').removeClass('queryeditor_add_on').addClass('queryeditor_add_off');
					$('#queryeditor-del').removeClass('queryeditor_del_on').addClass('queryeditor_del_off');
					$('#queryeditor-new').removeClass('queryeditor_new_on').addClass('queryeditor_new_off');
					$('#queryeditor-intersec').removeClass('queryeditor_intersec_off').addClass('queryeditor_intersec_on');
					break;
				default :
					$('#queryeditor-add').removeClass('queryeditor_add_on').addClass('queryeditor_add_off');
					$('#queryeditor-del').removeClass('queryeditor_del_on').addClass('queryeditor_del_off');
