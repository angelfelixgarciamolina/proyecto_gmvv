...
var pluginGraphicalQueries = $.extend({}, drawingBase,
{
	...
	addToolForm: function(container){
		...
		if ($("#GraphicalQueries_Buffer").length == 0) {
			...
			text += '<br/><fieldset id="GraphicalQueries_Select"  border=1">';
			text += '<legend><b>' + _p('GraphicalQueries_Select_text') + '</b></legend>';
			text += '<table><tr>';
			text += '<td id="new" class="graphicalqueries_new_on selectionType" onclick="javascript:PM.Plugin.' + this.pluginNameClt + '.setSelection(\'new\')" alt="'+ _p('GraphicalQueries_NewSelect_text')+ '" title="' + _p('GraphicalQueries_NewSelect_text')+ '"></td>';
			text += '<td id="add" class="graphicalqueries_add_on selectionType" onclick="javascript:PM.Plugin.' + this.pluginNameClt + '.setSelection(\'add\')" alt="'+ _p('GraphicalQueries_AddToSelect_text')+ '" title="' + _p('GraphicalQueries_AddToSelect_text')+ '"></td>';
			text += '<td id="intersec" class="graphicalqueries_intersec_on selectionType" onclick="javascript:PM.Plugin.' + this.pluginNameClt + '.setSelection(\'intersec\')" alt="'+ _p('GraphicalQueries_IntersecToSelect_text')+ '" title="' + _p('GraphicalQueries_IntersecToSelect_text')+ '"></td>';
			text += '<td id="del" class="graphicalqueries_del_on selectionType" onclick="javascript:PM.Plugin.' + this.pluginNameClt + '.setSelection(\'del\')" alt="'+ _p('GraphicalQueries_DelToSelect_text')+ '" title="' + _p('GraphicalQueries_DelToSelect_text')+ '"></td>'; 
	...
	setSelection: function(type) {
		...
		switch(type){
		case 'add': 
			$('#add').removeClass('graphicalqueries_add_off').addClass('graphicalqueries_add_on');
			$('#del').removeClass('graphicalqueries_del_on').addClass('graphicalqueries_del_off');
			$('#new').removeClass('graphicalqueries_new_on').addClass('graphicalqueries_new_off');
			$('#intersec').removeClass('graphicalqueries_intersec_on').addClass('graphicalqueries_intersec_off');
			break;
		case 'del': 
			$('#add').removeClass('graphicalqueries_add_on').addClass('graphicalqueries_add_off');
			$('#del').removeClass('graphicalqueries_del_off').addClass('graphicalqueries_del_on');
			$('#new').removeClass('graphicalqueries_new_on').addClass('graphicalqueries_new_off');
			$('#intersec').removeClass('graphicalqueries_intersec_on').addClass('graphicalqueries_intersec_off');
			break;
		case 'new':
			$('#add').removeClass('graphicalqueries_add_on').addClass('graphicalqueries_add_off');
			$('#del').removeClass('graphicalqueries_del_on').addClass('graphicalqueries_del_off');
			$('#new').removeClass('graphicalqueries_new_off').addClass('graphicalqueries_new_on');
			$('#intersec').removeClass('graphicalqueries_intersec_on').addClass('graphicalqueries_intersec_off');
			break;
		case 'intersec':
			$('#add').removeClass('graphicalqueries_add_on').addClass('graphicalqueries_add_off');
			$('#del').removeClass('graphicalqueries_del_on').addClass('graphicalqueries_del_off');
			$('#new').removeClass('graphicalqueries_new_on').addClass('graphicalqueries_new_off');
			$('#intersec').removeClass('graphicalqueries_intersec_off').addClass('graphicalqueries_intersec_on');
			break;
		default :
			$('#add').removeClass('graphicalqueries_add_on').addClass('graphicalqueries_add_off');
			$('#del').removeClass('graphicalqueries_del_on').addClass('graphicalqueries_del_off');
